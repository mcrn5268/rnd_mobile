                      ...
                      children: [
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon: Visibility(
                                      visible:
                                          _addGroupController.text.isNotEmpty,
                                      child: IconButton(
                                        icon: const Icon(Icons.close, size: 25),
                                        onPressed: () {
                                          setState(() {
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (username == '') {
                              _addUsernameErrorText = 'Username is empty';
                              proceed = false;
                            }
                            if (groupToUsernames[group] != null) {
                              if (groupToUsernames[group]!.contains(username)) {
                            ...
                            if (proceed) {
                              _addGroupErrorText = null;
                              _addUsernameErrorText = null;
                              bool createFlag = await FirestoreService().create(
                                  collection: 'groups',
                                  documentId: group,
                                  data: {username: true});
                              if (createFlag) {
                                if (!groupToUsernames.containsKey(group)) {
                      ...
                      children: [
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    errorText: _removeUsernameErrorText,
                                    suffixIcon: Visibility(
                                      visible: _removeUsernameController
                                          .text.isNotEmpty,
                                      child: IconButton(
                                        icon: const Icon(Icons.close, size: 25),
                                        onPressed: () {
                                  ...
                                  onTap: () {
                                    if (_removeUsernameErrorText != null) {
                                      setState(() {
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            bool proceed = true;
                            String group = _removeGroupController.text;
                            String username = _removeUsernameController.text;
                            if (group.isEmpty) {
                              _removeGroupErrorText = 'Group is empty';
                              proceed = false;
                            }
                            if (username.isEmpty) {
                              _removeUsernameErrorText = 'Username is empty';
                              proceed = false;
                            }
                            if (proceed) {
                              _removeGroupErrorText = null;
                              _removeUsernameErrorText = null;
                              if (!groupToUsernames.containsKey(group)) {
                                showToastMessage('$group group does not exist');
                                return;
                              }
                              ...
                              usernameToGroups[username]!.remove(group);
                              groupToUsernames[group]!.remove(username);
                              if (usernameToGroups[username]!.isEmpty) {
              ...
              FutureBuilder(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasError) {
                    ...
                    if (groupToUsernames.isEmpty && usernameToGroups.isEmpty) {
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: ListView.builder(
                                        itemCount: groupToUsernames.keys
                                            .where((group) => group
                                                .toLowerCase()
                                                .contains(_searchGroupController
                                                    .text
                                                    .toLowerCase()))
                                            .length,
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: ListView.builder(
                                      itemCount: usernameToGroups.keys
                                          ...
                                          .length,
                                      itemBuilder: (context, index) {
                                        String username = usernameToGroups.keys
                                            .where((username) => username
                                                .toLowerCase()
                                                .contains(
                                        ...
                                        final usernameGroupsLength =
                                            usernameToGroups[username]!.length;
                                        final groupText =
