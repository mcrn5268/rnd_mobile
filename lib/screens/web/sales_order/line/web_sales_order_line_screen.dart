...
import 'package:rnd_mobile/screens/web/sales_order/line/web_sales_order_line_more_screen.dart';
import 'package:rnd_mobile/utilities/session_handler.dart';

class WebSalesOrderLineScreen extends StatelessWidget {
  const WebSalesOrderLineScreen({required this.order, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text('Sales Order')),
      ),
      body: Column(
        children: [
          Padding(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(order.soNumber.toString(),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(order.debtorName.toString(),
                              textAlign: TextAlign.right,
                              style: const TextStyle(
                                  fontSize: 12, color: Colors.grey)),
                        ),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(order.salesRepName.toString(),
                              textAlign: TextAlign.right,
                              style: const TextStyle(
                                  fontSize: 12, color: Colors.grey)),
                        ),
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                          flex: 1,
                          child: Text(soDate.toString().trim(),
                              textAlign: TextAlign.left,
                              style: const TextStyle(
                                  fontSize: 12, color: Colors.grey))),
                      Expanded(
