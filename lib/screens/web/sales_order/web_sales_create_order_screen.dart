...
class WebSalesCreateOrderScreen extends StatefulWidget {
  const WebSalesCreateOrderScreen({super.key});

  @override
  State<WebSalesCreateOrderScreen> createState() =>
      _WebSalesCreateOrderScreenState();
}

class _WebSalesCreateOrderScreenState extends State<WebSalesCreateOrderScreen> {
  ...
  final ValueNotifier<bool> _itemsIsLoadingMore = ValueNotifier<bool>(false);
  ...
  final _particularsFocusNode = FocusNode();
  ...
  void initState() {
    ...
    // sales order date focus node listener
    _salesOrderDateFocusNode.addListener(() {
      if (_salesOrderDateFocusNode.hasFocus) {
        _selectDate(context, _salesOrderDateController, 'salesOrderDate');
      }
    });

    // delivery date focus node listener
    _deliveryDateFocusNode.addListener(() {
      if (_deliveryDateFocusNode.hasFocus) {
        _selectDate(context, _deliveryDateController, 'deliveryDate');
      }
    });
  ...
  Future<void> _selectDate(BuildContext context,
    ...
    if (type == 'salesOrderDate') {
      _salesOrderDateFocusNode.unfocus();
      _deliveryDateFocusNode.requestFocus();
    } else if (type == 'deliveryDate') {
      _deliveryDateFocusNode.unfocus();
      _particularsFocusNode.requestFocus();
    }
  }
            ...
            Row(
              children: [
                ...
                Expanded(
                  flex: 3,
                  child: TextField(
                    controller: _itemsLineNumberControllerList[itemIndex],
                    enabled: false,
                    decoration: InputDecoration(
                      ...
                      suffixIcon: Visibility(
                        visible: _itemsLineNumberControllerList[itemIndex]
                            .text
                            .isNotEmpty,
                        child: IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              _itemsLineNumberControllerList[itemIndex].clear();
                            });
                          },
                        ),
                      ),
                  ...
                  child: Stack(children: [
                    ...
                    StatefulBuilder(
                      ...
                      return Row(children: [
                                ...
                                onTap: () async {
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Expanded(
                                                                              flex: 1,
                                                                              child: Text('Item', textAlign: TextAlign.left, style: TextStyle(fontSize: 12, color: Colors.grey))),
                                                                          Expanded(
                                                                              flex: 2,
                                                                              child: Text('Description', textAlign: TextAlign.left, style: TextStyle(fontSize: 12, color: Colors.grey))),
                                                                          Expanded(
                                                                              flex: 2,
                                                                              child: Text('Group', textAlign: TextAlign.left, style: TextStyle(fontSize: 12, color: Colors.grey))),
                                                                          Expanded(
                                                                              flex: 1,
                                                                              child: Text('Stock', textAlign: TextAlign.right, style: TextStyle(fontSize: 12, color: Colors.grey))),
                                                                          Expanded(
                                                                              flex: 1,
                                                                              child: Text('Unit', textAlign: TextAlign.right, style: TextStyle(fontSize: 12, color: Colors.grey))),
                                                                          Expanded(
                                                                              flex: 1,
                                                                              child: Text('Cost Method', textAlign: TextAlign.right, style: TextStyle(fontSize: 12, color: Colors.grey))),
                                                                          Expanded(
                                                                              flex: 1,
                                                                              child: Text('Selling Price', textAlign: TextAlign.right, style: TextStyle(fontSize: 12, color: Colors.grey))),
                                                                        ],
                                                                      ),
                                                                    ),
                                                                  ),
                                  ...
                                  if (item != null) {
                                    setState(() {
                                      ...
                                      _itemsUnitControllerList[itemIndex].text =
                                          item[5];
                                      _itemsControllerList[itemIndex].text =
                                          item[2];
                                    });
                                  }
                                },
                        ...
                        Visibility(
                          visible:
                              _itemsControllerList[itemIndex].text.isNotEmpty,
                          child: IconButton(
                            icon: const Icon(Icons.close, size: 25),
                            onPressed: () {
                              setState(() {
                ...
                Expanded(
                  ...
                  child: StatefulBuilder(
                      builder: (BuildContext context, StateSetter setState) {
                    return TextField(
                      controller: _itemsQuantityControllerList[itemIndex],
                      decoration: InputDecoration(
                        labelText: 'Quantity',
                        labelStyle:
                            const TextStyle(fontSize: 12, color: Colors.grey),
                        ...
                        fillColor: MediaQuery.of(context).platformBrightness ==
                            ...
                            : Colors.white,
                        suffixIcon: Visibility(
                          visible: _itemsQuantityControllerList[itemIndex]
                              .text
                              .isNotEmpty,
                          child: IconButton(
                            focusNode: FocusNode(skipTraversal: true),
                    ...
                    return TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        fillColor: MediaQuery.of(context).platformBrightness ==
                            ...
                            : Colors.white,
                        suffixIcon: Visibility(
                          visible: _conversionFactorController.text.isNotEmpty,
                          child: IconButton(
                            focusNode: FocusNode(skipTraversal: true),
                            icon: const Icon(Icons.close, size: 25),
                            onPressed: () {
                ...
                Expanded(
                  ...
                  child: StatefulBuilder(
                      builder: (BuildContext context, StateSetter setState) {
                    return TextField(
                      controller: _itemsPriceControllerList[itemIndex],
                      decoration: InputDecoration(
                        ...
                        fillColor: MediaQuery.of(context).platformBrightness ==
                            ...
                            : Colors.white,
                        suffixIcon: Visibility(
                          visible: _itemsPriceControllerList[itemIndex]
                              .text
                              .isNotEmpty,
                          child: IconButton(
                            focusNode: FocusNode(skipTraversal: true),
                ...
                children: [
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      readOnly: true,
                      onTap: () => _selectDate(
                          context, _salesOrderDateController, 'salesOrderDate'),
                    ),
                  ),
                  const SizedBox(
                    width: 15,
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      readOnly: true,
                      onTap: () => _selectDate(
                          context, _deliveryDateController, 'deliveryDate'),
                    ),
                  ),
                  const SizedBox(
                    width: 15,
                ...
                children: [
                  ...
                  Expanded(
                    child: Autocomplete<Debtor>(
                      displayStringForOption: (Debtor option) =>
                          option.debtorName,
                      optionsBuilder:
                        ...
                        if (!salesOrderFlag) {
                          if (_debtorController.text.length < 2) {
                            //use main list for search if  input character <2
                            return _debtors
                                .where((debtor) => debtor.contains(
                            ...
                            if (_prevSearchResult.containsKey('debtor') &&
                              ...
                              return _prevSearchResult['debtor']
                              ...
                              _prevSearchResult['debtor']
                                  [textEditingValue.text] = searchResult;
                              return searchResult;
                            }
                          }
                        } else {
                      ...
                      //                 // The user has reached the bottom of the SingleChildScrollView
                      ...
                      //                       onPressed: () {
                      //                         // Handle what happens when the custom button is pressed
                      //                       },
                      //                     ),
                      //                   ),
                      //                 ],
                  ...
                  //         if (_debtors.isEmpty) {
                  //           final result =
                  //               await SalesOrderService.getDebtorView(
                  //                   sessionId: userProvider.user!.sessionId);
                  ...
                  //             _prevSearchResult['debtor'][closestMatch[2]] =
                  //                 _prevSearchResult['debtor'][value]
                  //                     .where((string) => string
                  //                         .toString()
                  //                         .toLowerCase()
                  //                         .contains(
                  ...
                  //               _prevSearchResult['debtor'] = {};
                  //             }
                  //             _prevSearchResult['debtor'][pattern] =
                  //                 searchResult;
                  //             return searchResult;
                  //           }
                  //         }
                          ...
                          if (!salesOrderFlag) {
                            ...
                            if (_prevSearchResult.containsKey('warehouse') &&
                                _prevSearchResult['warehouse']
                                    .containsKey(value)) {
                              closestMatch = _prevSearchResult['warehouse']
                                      [value]
                                  .firstWhere(
                                      (warehouse) => warehouse
                                          .toString()
                          ...
                          if (!salesOrderFlag) {
                            ...
                            if (_prevSearchResult.containsKey('salesRep') &&
                                _prevSearchResult['salesRep']
                                    .containsKey(value)) {
                              closestMatch = _prevSearchResult['salesRep']
                                      [value]
                                  .firstWhere(
                                      (salesRep) => salesRep
                                          .toString()
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      dynamic debtorID = _selectedDebtor.isNotEmpty
                          ? _selectedDebtor[0]
                          : null;
                      if (debtorID == null) {
                      ...
                      String? particulars =
                          _particularsController.text.isNotEmpty
