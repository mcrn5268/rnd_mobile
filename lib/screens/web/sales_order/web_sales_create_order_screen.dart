              ...
              Expanded(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: Visibility(
                      visible:
                          _itemsLineNumberControllerList[index].text.isNotEmpty,
                      child: IconButton(
                        focusNode: FocusNode(skipTraversal: true),
                        icon: const Icon(Icons.close, size: 25),
                        onPressed: () {
                          setState(() {
                            _itemsLineNumberControllerList[index].clear();
                          });
                        },
                      ),
                    ),
                              ...
                              onTap: () async {
                                ...
                                if (item != null) {
                                  setState(() {
                                    ...
                                    _itemsUnitControllerList[index].text =
                                        item[5];
                                    _itemsControllerList[index].text = item[2];
                                  });
                                }
                              },
                              child: const SizedBox(height: 51))),
                      Visibility(
                        visible: _itemsControllerList[index].text.isNotEmpty,
                        child: IconButton(
                          icon: const Icon(Icons.close, size: 25),
                          onPressed: () {
                            setState(() {
                ...
                child: StatefulBuilder(
                  ...
                  return TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: Visibility(
                        visible:
                            _itemsQuantityControllerList[index].text.isNotEmpty,
                        child: IconButton(
                          focusNode: FocusNode(skipTraversal: true),
                          icon: const Icon(Icons.close, size: 25),
                          onPressed: () {
                ...
                child: StatefulBuilder(
                  ...
                  return TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderSide: BorderSide(
                            color: _itemBaseSellingPriceErrorText[index] != null
                                ? Colors.red
                                : Colors.grey),
                        borderRadius: BorderRadius.circular(10.0),
                      ),
                      ...
                      errorText: _itemBaseSellingPriceErrorText[index],
                      errorStyle: const TextStyle(color: Colors.red),
                      filled: true,
                      fillColor: MediaQuery.of(context).platformBrightness ==
                              Brightness.dark
                      ...
                      suffixIcon: Visibility(
                        visible:
                            _itemsPriceControllerList[index].text.isNotEmpty,
                        child: IconButton(
                          focusNode: FocusNode(skipTraversal: true),
                          icon: const Icon(Icons.close, size: 25),
                          onPressed: () {
